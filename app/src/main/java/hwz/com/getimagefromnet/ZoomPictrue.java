...
public class ZoomPictrue
{
                                            ...
                                            int reqWidth, int reqHeight)
    {
        ...
        if (height > reqHeight || width > reqWidth)
        {
            ...
            // 选择比最小为insamplesize值，保证与尺寸大于或等于所要求的高度和宽度的最终图像。
                                                         ...
                                                         int resId, int reqWidth, int reqHeight)
    {
        ...
        // 第一解码injustdecodebounds =true 检查尺寸
                                                       ...
                                                       int reqWidth, int reqHeight)
    {
        final BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
        Bitmap bitmap = BitmapFactory.decodeFile(IMAGE_FILE_LOCATION + path, options);// 此时返回bm为空
            ...
            BufferedOutputStream bos =
                    new BufferedOutputStream(
                        new FileOutputStream(
                            new File(IMAGE_FILE_LOCATION+ fileName)));
